<#
.SYNOPSIS
   Gets SCSI LUN data from a VMWare cluster.
.PARAMETER clusName
   The name of the cluster to retrieve data for.
.PARAMETER csvName
   The name of the file to ouput the results to.
.NOTES
   Written by LucD ("http://www.lucd.info/2010/04/09/lun-report-datastores-rdms-and-node-visibility/")
#>
