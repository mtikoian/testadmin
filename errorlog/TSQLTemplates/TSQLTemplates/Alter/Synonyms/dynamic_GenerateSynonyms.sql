...
$Author: smclarnon $
$Date: 2012-11-06 06:34:11 -0500 (Tue, 06 Nov 2012) $
$Revision: 563 $
$URL: http://seisubvapp01/EnhancedClientReporting/Build/20120912_Full_SharedMaster/SQLScripts/GenerateSynonyms.sql $ 
...
if exists (
    ...
    print 'Procedure dbo.GenerateSynonyms, $Rev: 563 $ was created successfully'
end else begin
