	...
	BEGIN
		IF EXISTS (
				...
				WHERE object_id = object_id('dbo.DW_FUNCTION_ITEM')
					AND NAME = 'IDX__DW_FUNCTION_ITEM_FN_ID_FN_LVL_NUM_FN_SEQ_NUM_PRNT_FN_ID'
				)
		BEGIN
			DROP INDEX IDX__DW_FUNCTION_ITEM_FN_ID_FN_LVL_NUM_FN_SEQ_NUM_PRNT_FN_ID ON dbo.DW_FUNCTION_ITEM;

			PRINT 'Dropped Index IDX__DW_FUNCTION_ITEM_FN_ID_FN_LVL_NUM_FN_SEQ_NUM_PRNT_FN_ID on DW_FUNCTION_ITEM';
		END;
		ELSE
		BEGIN
			PRINT 'Index IDX__DW_FUNCTION_ITEM_FN_ID_FN_LVL_NUM_FN_SEQ_NUM_PRNT_FN_ID doesnt exists on DW_FUNCTION_ITEM!!!';
