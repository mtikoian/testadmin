---------------------------------------------------------------------------
-- Project: AGA 12.1 Release- Role creation for AGA UI
-- @owner vkotian
--Created: 04/06/2012
--
-- Description:
...
--    
-- NOTE:
--	Updated : vkotian 4/6/2012-role is created if it does not exist
--
-- ---------------------------------------------------------------------------
...
use [$(DBNAME)]    ;
    ...
    print '***** Project: AGA 12.1 Release- AGA UI Role *****';
