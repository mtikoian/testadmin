...
Description: Know Your Client Data Services (cds) Schema Grant  
                ...
                Adds the application domain account "CTC\IMSKYC_SVC_WEB" as a 
...
IF NOT  EXISTS (SELECT * FROM sys.database_principals WHERE name = N'CTC\IMSKYC_SVC_WEB')
CREATE USER [CTC\IMSKYC_SVC_WEB] FOR LOGIN [CTC\IMSKYC_SVC_WEB_QA] WITH DEFAULT_SCHEMA=[dbo];
GO
...
EXEC sp_addrolemember 'u_role_cds', 'CTS\IMSKYC_SVC_WEB'
