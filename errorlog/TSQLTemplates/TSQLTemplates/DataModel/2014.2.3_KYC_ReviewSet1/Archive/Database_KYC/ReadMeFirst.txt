...
***********************************************************
Project  			: Know Your Client Data Services
Developer			: Rob McKenna
Extension			: X3922
Goldcode location	: \\atlas\MANAGEDACCTS\KnowYourClient\deployments\CDSUpdatePackage08_PT
***********************************************************

Changed in this build:

1) Pending Transaction Build


NOTE: What follows are unchanged template deployment instructions.
****
