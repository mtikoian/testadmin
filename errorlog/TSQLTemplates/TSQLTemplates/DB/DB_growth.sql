DECLARE @TargetDatabase sysname; SET @TargetDatabase = NULL  --  NULL = all dbs
DECLARE @Level varchar(10); SET @Level = 'Database';     --  "Database" or "File"
DECLARE @UpdateUsage bit; SET @UpdateUsage = 0;          --  default no update
DECLARE @Unit char(2); SET @Unit = 'MB'                  --  Megabytes, Kilobytes or Gigabytes
