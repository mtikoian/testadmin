...
DECLARE @XELPath VARCHAR(max) = '<XEL Folder Path, varchar(max), D:\Customers\114041011352392\c1442832-8983-470a-8f0b-ba8b1dd76760\GBSQLNODE1_MSSQLSERVER_FailoverCluster_health_XeLogs\>'
IF RIGHT(@XELPath, 1) <> '\'
    SELECT @XELPath += '\'
