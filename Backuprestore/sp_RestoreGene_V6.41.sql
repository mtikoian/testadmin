...
/*********************************************************************************************
Restore Generator v6.41 (2016-09-04)
(C) 2012, Paul Brewer
...
September 4th, 2016  - V6.41 - PoSh Driver Last LSN minor fix.
...
BEGIN
    ...
    SELECT
        ...
        CASE b.type_desc 
            ...
            WHEN 'FILESTREAM' THEN
                ...
                ELSE @WithMoveFileStreamFile_ + SUBSTRING (b.Physical_Name, (LEN(b.Physical_Name)-CHARINDEX('\',REVERSE(b.Physical_Name)) + 2),CHARINDEX('\',REVERSE(b.Physical_Name)) - 1 - CHARINDEX('.',REVERSE(b.Physical_Name))) +  '_' + @TargetDatabase_ + '.ndf'  END 
            END  
    ...
    WHERE #CTE.[type] = 'D'
    AND b.type_desc IN ('ROWS','FILESTREAM')
    AND b.file_id > 2
