...
#  Revisions: v 0.1
#             v 0.2 Removed connection test. Removed quotes
#                   from around $args[0] in connection string.
#             v 0.3 Added try catch.
#             v 0.4 Removed intermediate Excel close.
#             v 0.5 Added server information script.
#             v 0.6 Added verbose statements.
##################################################################
