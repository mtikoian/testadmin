...
{
    param ([hashtable]$ht, $chartType='Column', [string] $chartTitle, $xTitle,$yTitle, [int]$width,[int]$height,[int]$left,[int]$top,[bool]$asc)
...
function New-LineChart
{
    ...
    param ([hashtable]$ht, [string] $chartTitle, [int]$width,[int]$height,[int]$left,[int]$top)
