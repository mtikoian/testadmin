##########################################################
# REAL TIME Column Chart - Delta Snapshots
##########################################################
## Example written by Rob Risetto (DBInsight)
...
out-chart -xField 'Waittype' -yField 'AvgWait_S'  -ChartTitle 'DELTA WAIT STATISTICS (Real Time) - 2 Second Snapshot'  -chartType 'Column' -scriptBlock {
...
"
 ...
 $DataSet.Tables[0] | select WaitType, AvgWait_S
